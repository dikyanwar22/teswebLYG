          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form action="<?= site_url('api/Documentation/action_add_list_api'); ?>" method="POST" role="form">
                  <div class="box-body">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Ex : API upload bukti transaksi" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Kegunaan API</label>
                        <input type="text" name="ket_nama" class="form-control" placeholder="Ex : API ini digunakan untuk" required>
                      </div>
                    </div>
              ...
              <div class="col-md-12" id="inputan_body">
                <div class="form-group">
                  ...
                  <textarea name="inputan" class="form-control" rows="3" placeholder="Inputan Body"></textarea>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea name="hasil" class="form-control" rows="3" placeholder="Hasil API" required></textarea>
                </div>
              </div>
