            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="<?= site_url('Menu/action_add_menu'); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="menu" id="menu" placeholder="Nama Menu" required class="form-control">
                    </div>
                    <div class="form-group">
                      <label><b>URI</b></label>
                      <input type="text" name="uri" id="uri" required class="form-control">
                    </div>
                    <div class="form-group">
                      <label><b>Icon Menu</b></label>
                      <input type="text" name="icon" placeholder="Icon Menu" class="form-control">
                    </div>
                    <div class="form-group">
