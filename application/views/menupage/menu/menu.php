              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <a href="<?= site_url('Menu/add_menu'); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah</a>
                  </div>
                      ...
                      <table class="table table-striped" id="table-2">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><b style="color: red"><?= $v->file; ?></b></td>
                            ...
                            <td>
                              <a href="<?= site_url('Menu/edit_menu/'.$id); ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                            </td>
                          </tr>
                          <?php $no++; endforeach; ?>
                        </tbody>
