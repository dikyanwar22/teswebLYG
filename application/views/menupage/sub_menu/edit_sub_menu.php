            ...
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="<?= site_url('Menu/action_edit_sub_menu/'.$e->id); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <select name="menu_id" class="form-control select2" required>
                        ...
                        <option value="<?= $v->id; ?>" <?= ($v->id == $e->menu_id) ? 'selected' : ''; ?> >[Menu: <?= $v->menu; ?>]</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                    <div class="form-group">
                      <label><b>Nama Sub Menu</b></label>
                      <input type="text" id="menu" name="sub_menu" value="<?= $e->nama; ?>" required class="form-control">
                    </div>
                    <div class="form-group">
                      <label><b>URI</b></label>
