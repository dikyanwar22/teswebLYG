...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="<?= base_url('assets/stisla/assets/modules/bootstrap-social/bootstrap-social.css'); ?>">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="https://cdn-icons-png.freepik.com/256/3135/3135715.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <form method="POST" action="<?= site_url('Login/auth'); ?>" class="needs-validation" novalidate="">
            ...
            <div class="simple-footer">
              Copyright &copy; Diky Anwar <?= date('Y'); ?>
            </div>
          </div>
        </div>
      </div>
